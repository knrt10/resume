...
\begin{rSection}{Summary}
  ...
  {
    \item CKS, CKA. Experience with kernel, backend web services and open source development. Worked in SRE, distributed systems, dev tools and systems programming.
  }
  \end{rSummarySection}
\end{rSection}
...
\begin{rSection}{Experience}
  ...
  \begin{rWorkSection}{Microsoft}
                     ...
                     {Software Engineer 2}
                     {May'21 -- Present} {
    \item Working on the Azure core team.
  }
  \end{rWorkSection}
